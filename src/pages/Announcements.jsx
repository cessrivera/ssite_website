            ...
            <div className="p-6 md:p-8 overflow-y-auto overflow-x-hidden grow min-w-0">
              {selectedAnnouncement.content && (
                selectedAnnouncement.content.includes('<') ? (
                  <div className="prose max-w-none text-gray-700 leading-relaxed wrap-anywhere **:max-w-full [&_img]:h-auto [&_pre]:whitespace-pre-wrap [&_pre]:wrap-anywhere" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(selectedAnnouncement.content) }} />
                ) : (
