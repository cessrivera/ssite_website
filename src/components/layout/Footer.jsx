        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/login" className="text-blue-200 hover:text-white text-sm transition-colors">Membership</Link></li>
            </ul>
          </div>

          {/* Connect */}
          <div className="lg:col-span-3">
            <h4 className="font-semibold mb-5 text-yellow-400">Connect With Us</h4>
          ...
          <div className="lg:col-span-3 min-w-0">
            ...
            <div className="flex flex-col items-start gap-4 sm:flex-row">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-sm text-blue-200 text-center leading-5">Research Archive</span>
              </div>
            </div>
          </div>
        </div>
