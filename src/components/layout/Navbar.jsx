...
const permissionLandingPages = [
  { permission: 'announcements', path: '/admin/announcements', label: 'Manage Updates' },
  { permission: 'events', path: '/admin/events', label: 'Manage Events' },
  { permission: 'officers', path: '/admin/officers', label: 'Manage Officers' },
  { permission: 'polls', path: '/admin/polls', label: 'Manage Polls' }
];
